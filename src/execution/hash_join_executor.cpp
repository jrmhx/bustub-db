...
HashJoinExecutor::HashJoinExecutor(ExecutorContext *exec_ctx, const HashJoinPlanNode *plan,
    ...
    : AbstractExecutor(exec_ctx), plan_(plan), left_child_(std::move(left_child)), right_child_(std::move(right_child)),
      right_tuple_matched_(false), right_tuple_ready_(false), processing_unmatched_left_(false) {
...
auto HashJoinExecutor::JoinKeyEqual::operator()(const std::vector<Value> &lhs, const std::vector<Value> &rhs) const -> bool {
